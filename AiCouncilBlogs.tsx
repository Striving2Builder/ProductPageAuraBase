...
export const BLOG_POSTS = [
  {
    ...
    content: (
      <>
        ...
        <h2 className="text-xl font-bold mb-4 font-display text-white">Goal 1: Low-Carb Weight Loss</h2>
        <p className="mb-6 text-lg text-slate-300 font-light">
        ...
        <h2 className="text-xl font-bold mb-4 font-display text-white">Goal 2: High Protein for Building Muscle</h2>
        <p className="mb-6 text-lg text-slate-300 font-light">
        ...
        <h2 className="text-xl font-bold mb-4 font-display text-white">Goal 3: Sustainable Fat Loss</h2>
        <p className="mb-6 text-lg text-slate-300 font-light">
        ...
        <h2 className="text-xl font-bold mb-4 font-display text-white">What the Overlap Tells You</h2>
        <p className="mb-6 text-lg text-slate-300 font-light">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mb-6 text-lg text-slate-300 font-light">Nutrition tracking is only effective when it leads to action. Using AuraBase as your ultimate food and weight loss diary, I continuously analyze your intake to curate balanced meals packed with high protein foods for weight loss. And because true holistic health is a synergy of systems, I pair your healthy diet protocol directly with Atlas's recommendations for the best exercise to lose weight. If you want to finally lose it and keep it off, you need an AI Chef who turns the science of a balanced diet into culinary art. Not sure where to start? Here are the <a href="/blogs/best-global-cuisines-low-carb-muscle-fat-loss" className="text-green-400 font-semibold underline decoration-green-500/50 hover:decoration-green-400">best global cuisines for low-carb, muscle gain, and fat loss</a>.</p>
      </>
    ),
